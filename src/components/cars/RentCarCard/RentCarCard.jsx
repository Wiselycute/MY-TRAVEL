...
const RentCarCard = ({ data }) => {
  return (
    <div className='w-full max-w-[352px] bg-background rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden'>
      ...
      <div className='flex flex-col p-4 sm:p-5'>
        <div className='w-full flex flex-col gap-3'>
          ...
          {/* Title */}
          <h3 className='text-xl sm:text-2xl font-bold text-primary leading-tight w-full'>
            {data.title}
          </h3>
          ...
          <div className='flex items-center gap-2 w-full flex-wrap'>
            <div className='flex items-center gap-1.5 sm:gap-2 px-3 py-2 rounded-lg bg-secondary hover:bg-[#E5E3E3] transition-colors duration-200'>
              <Users className='w-4 h-4 sm:w-5 sm:h-5 text-gray-700' />
              <span className='text-xs sm:text-sm font-medium text-gray-700 whitespace-nowrap b'>{data.seats} seats</span>
            </div>
